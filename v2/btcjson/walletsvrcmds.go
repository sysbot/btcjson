...
func init() {
	...
	MustRegisterCmd("getaccount", (*GetAccountCmd)(nil))
	MustRegisterCmd("getaccountaddress", (*GetAccountAddressCmd)(nil))
	MustRegisterCmd("getaddressesbyaccount", (*GetAddressesByAccountCmd)(nil))
	MustRegisterCmd("getbalance", (*GetBalanceCmd)(nil))
	MustRegisterCmd("getnewaddress", (*GetNewAddressCmd)(nil))
	MustRegisterCmd("getrawchangeaddress", (*GetRawChangeAddressCmd)(nil))
	MustRegisterCmd("getreceivedbyaccount", (*GetReceivedByAccountCmd)(nil))
	...
	MustRegisterCmd("listlockunspent", (*ListLockUnspentCmd)(nil))
	MustRegisterCmd("listreceivedbyaccount", (*ListReceivedByAccountCmd)(nil))
	MustRegisterCmd("listreceivedbyaddress", (*ListReceivedByAddressCmd)(nil))
	MustRegisterCmd("listsinceblock", (*ListSinceBlockCmd)(nil))
	MustRegisterCmd("listtransactions", (*ListTransactionsCmd)(nil))
	MustRegisterCmd("listunspent", (*ListUnspentCmd)(nil))
	MustRegisterCmd("lockunspent", (*LockUnspentCmd)(nil))
	MustRegisterCmd("move", (*MoveCmd)(nil))
	MustRegisterCmd("sendfrom", (*SendFromCmd)(nil))
	MustRegisterCmd("sendmany", (*SendManyCmd)(nil))
	MustRegisterCmd("sendtoaddress", (*SendToAddressCmd)(nil))
	MustRegisterCmd("setaccount", (*SetAccountCmd)(nil))
	MustRegisterCmd("settxfee", (*SetTxFeeCmd)(nil))
	MustRegisterCmd("signmessage", (*SignMessageCmd)(nil))
	MustRegisterCmd("signrawtransaction", (*SignRawTransactionCmd)(nil))
	MustRegisterCmd("walletlock", (*WalletLockCmd)(nil))
	MustRegisterCmd("walletpassphrase", (*WalletPassphraseCmd)(nil))
	MustRegisterCmd("walletpassphrasechange", (*WalletPassphraseChangeCmd)(nil))
}
