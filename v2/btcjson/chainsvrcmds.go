...
func init() {
	MustRegisterCmd("addnode", (*AddNodeCmd)(nil))
	...
	MustRegisterCmd("decodescript", (*DecodeScriptCmd)(nil))
	MustRegisterCmd("getaddednodeinfo", (*GetAddedNodeInfoCmd)(nil))
	MustRegisterCmd("getbestblockhash", (*GetBestBlockHashCmd)(nil))
	MustRegisterCmd("getblock", (*GetBlockCmd)(nil))
	MustRegisterCmd("getblockchaininfo", (*GetBlockChainInfoCmd)(nil))
	MustRegisterCmd("getblockcount", (*GetBlockCountCmd)(nil))
	MustRegisterCmd("getblockhash", (*GetBlockHashCmd)(nil))
	MustRegisterCmd("getblocktemplate", (*GetBlockTemplateCmd)(nil))
	MustRegisterCmd("getchaintips", (*GetChainTipsCmd)(nil))
	MustRegisterCmd("getconnectioncount", (*GetConnectionCountCmd)(nil))
	MustRegisterCmd("getdifficulty", (*GetDifficultyCmd)(nil))
	MustRegisterCmd("getgenerate", (*GetGenerateCmd)(nil))
	MustRegisterCmd("gethashespersec", (*GetHashesPerSecCmd)(nil))
	MustRegisterCmd("getinfo", (*GetInfoCmd)(nil))
	MustRegisterCmd("getmempoolinfo", (*GetMempoolInfoCmd)(nil))
	MustRegisterCmd("getmininginfo", (*GetMiningInfoCmd)(nil))
	MustRegisterCmd("getnetworkinfo", (*GetNetworkInfoCmd)(nil))
	MustRegisterCmd("getnettotals", (*GetNetTotalsCmd)(nil))
	MustRegisterCmd("getnetworkhashps", (*GetNetworkHashPSCmd)(nil))
	MustRegisterCmd("getpeerinfo", (*GetPeerInfoCmd)(nil))
	MustRegisterCmd("getrawmempool", (*GetRawMempoolCmd)(nil))
	MustRegisterCmd("getrawtransaction", (*GetRawTransactionCmd)(nil))
	MustRegisterCmd("gettxout", (*GetTxOutCmd)(nil))
	MustRegisterCmd("gettxoutsetinfo", (*GetTxOutSetInfoCmd)(nil))
	MustRegisterCmd("getwork", (*GetWorkCmd)(nil))
	MustRegisterCmd("help", (*HelpCmd)(nil))
	...
	MustRegisterCmd("submitblock", (*SubmitBlockCmd)(nil))
	MustRegisterCmd("validateaddress", (*ValidateAddressCmd)(nil))
	MustRegisterCmd("verifychain", (*VerifyChainCmd)(nil))
	MustRegisterCmd("verifymessage", (*VerifyMessageCmd)(nil))
}
